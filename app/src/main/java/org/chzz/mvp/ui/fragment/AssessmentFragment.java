 ...
 * ============================================================
 **/
public class AssessmentFragment extends BaseFragment implements NormalRecyclerViewAdapter.IFillDataListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        mCHZZRecyclerView = new CHZZRecyclerView(getActivity(), R.layout.item_normal,true, this);
